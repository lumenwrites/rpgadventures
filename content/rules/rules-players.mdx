...
### Schools and Spells
Abilities and Spells are organized into Schools (like Warfare, Stealth, Charm, Necromancy) and Skill Levels  (Novice, Initiate, Adept, Expert, Master).

You can learn "Novice" level powers right away. To progress to the more advanced level in the school, you need to learn at least one power from the previous level. So if you want to be able to learn Adept-level Illusionism spells, you need to know one Initiate-level Illusionism spells.

<Power power={exampleSpell} sample />

This spell costs **4** Energy Points to cast, **5** Experience Points to learn, and requires **Expert** level skills in **Illusionism** school.
...
Using this ability costs **2** Energy points. To learn it, you need to spend **3** Experience points, and you must have **Adept** skill level in **Survival** school.
...
You start with 12 Health, 12 Energy, and 12 Experience.

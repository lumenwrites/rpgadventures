...
If you want to play with the <Link to="/dice-rolling">dice rolling rules</Link> on Discord, you can set up an [Avrae bot](https://avrae.io/) to roll the dice automatically for you.

First, [click here](https://invite.avrae.io/) to invite the bot to your server (select your server from the dropdown menu and click "Continue").

Then, copy-paste the following commands into your chat (each command as a separate message):

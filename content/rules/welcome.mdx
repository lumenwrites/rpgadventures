...
The rules of Mirage are very simple, yet flexible, powerful and fun. They're designed to encourage imagination, creativity, and storytelling, and then fade into the background and stay out of the way of roleplaying.
...
If this sounds interesting - go read the <Link to="/rules">rules</Link> (don't worry, they're short and simple), and then join our [discord community](https://discord.gg/zt4N23d) to find people you can play with.

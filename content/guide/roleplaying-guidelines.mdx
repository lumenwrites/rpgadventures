...
Try to describe what you do vividly, don't be afraid to add fun details to the story. Try to engage multiple senses, describe how does the scene look like, sound like, smell like, etc.
...
### Act it out
Think about your character's distinctive features, quirks, unique speech patterns. Don't be shy to do a sily voice.

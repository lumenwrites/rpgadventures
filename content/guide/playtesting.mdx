...
Discuss your abilities with the GM. If an ability is too powerful, add a cost or a limitation - maybe it takes time to use, has negative consequences (attracts attention, is unpredictable, puts you in danger, etc), maybe can only be used once (treat it as a potion), and so on. 
